 ...
 */
#ifndef __MX6ULLFIRE_LITE_CONFIG_H
#define __MX6ULLFIRE_LITE_CONFIG_H
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootcmd=nand read ${fdt_addr} 0x400000 0x100000;"  \
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"boot=mmc check;${devtype} dev ${mmcdev};mmc rescan; " \
		...
		"echo loading dtb ...; "\
		"load ${devtype} ${bootpart} 0x83000000 /imx6ull-mmc-npi-lite.dtb;"\
